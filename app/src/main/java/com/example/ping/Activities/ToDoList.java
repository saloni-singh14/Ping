...
import com.example.ping.Models.TaskModel;
...
public class ToDoList extends AppCompatActivity  implements SearchView.OnQueryTextListener {
    FirebaseRecyclerAdapter<TaskModel, ToDoList.MyViewHolder> adapter;
    ...
    protected void onStart() {
        ...
        adapter = new FirebaseRecyclerAdapter<TaskModel, MyViewHolder>(options) {
            ...
            @Override
            protected void onBindViewHolder(@NonNull ToDoList.MyViewHolder holder, int position, @NonNull TaskModel model) {

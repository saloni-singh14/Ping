...
import com.example.ping.Adapters.FriendListRecyclerViewAdapter;
import com.example.ping.Adapters.ShowFriendListRecyclerViewAdapter;
import com.example.ping.Adapters.VideoMessageAdapter;
import com.example.ping.Layout.GridVideoViewContainer;
import com.example.ping.Layout.RecyclerItemClickListener;
import com.example.ping.Models.AgoraUser;
import com.example.ping.Models.DBUser;
import com.example.ping.Models.MessageBean;
import com.example.ping.Models.MessageListBean;
import com.example.ping.Models.UserStatusData;
import com.example.ping.R;
import com.example.ping.rtm.AGApplication;
import com.example.ping.rtm.ChatManager;
import com.example.ping.utils.Constant;
import com.example.ping.utils.MessageUtil;
...
public class VideoCallActivity extends AppCompatActivity {public static final int LAYOUT_TYPE_DEFAULT = 0;
    ...
    private void connectToFireDB(final String userName) {
        mRef = database.getReference("VideoUsers");
    ...
    private void startMessaging(String userName) {
        ...
        if (messageListBean != null) {
            ...
            mMessageAdapter = new VideoMessageAdapter(this, mMessageBeanList);

...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ///receiverUid is sent from previous activity
        ...
        senderRoom = senderUid + receiverUid;///create rooms for sender and receiver with unique names
        receiverRoom = receiverUid + senderUid;

        adapter = new MessagesAdapter(this, messages, senderRoom, receiverRoom);///Message Adapter constructor is called
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for(DataSnapshot snapshot1 : snapshot.getChildren()) {
                            ...
                            message.setMessageId(snapshot1.getKey());///The key generated by Firebase is stored as messageID
        ...
        binding.sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Date date = new Date();///Date class gives the timestamp of the message
                Message message = new Message(messageTxt, senderUid, date.getTime());
                binding.messageBox.setText("");

                String randomKey = database.getReference().push().getKey();
                ///Using Random key ensures that the message gets stored in both rooms with the same key
                HashMap<String, Object> lastMsgObj = new HashMap<>();///HashMap is used for storing Chat history
                            ...
                            if(task.isSuccessful()) {
                                reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                    ...
                                    public void onSuccess(Uri uri) {
                                        ...
                                        /// to the specified Firebase Reference
                                        ///Using Random key ensures that the message gets stored in both rooms with the same key
                                        String randomKey = database.getReference().push().getKey();

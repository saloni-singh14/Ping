...
public class VideoMessageAdapter extends RecyclerView.Adapter<VideoMessageAdapter.MyViewHolder> {

    private List<MessageBean> messageBeanList;
    private LayoutInflater inflater;

    public VideoMessageAdapter(Context context, List<MessageBean> messageBeanList) {
